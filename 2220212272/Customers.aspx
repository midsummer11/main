...
<asp:Content ID="Content2" ContentPlaceHolderID="MyContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="mb-3">
                <label for="" class="form-label" style="color:#805475">用户名</label>
                <input type="text" placeholder="" autocomplete="off" class="form-control " id="CNameTb" runat="server"/>
            </div>
            <div class="mb-3">
                <label for="" class="form-label" style="color:#805475">电子邮箱</label>
                <input type="email" placeholder="" autocomplete="off" class="form-control " id="EmailTb" runat="server"/>
            </div>
            <div class="mb-3">
                <label for="" class="form-label" style="color:#805475">电话号码</label>
                <input type="text" placeholder="" autocomplete="off" class="form-control " id="PhoneTb" runat="server"/>                   
            </div>
            <div class="mb-3">
                <label for="" class="form-label" style="color:#805475">密码</label>
                <input type="text" placeholder="" autocomplete="off" class="form-control " id="PassTb" runat="server"/>
            </div>
        ...
        <div class="col-md-8">               
            <asp:GridView ID="CustomerList" runat="server" AutoGenerateSelectButton="True" class="table" CellPadding="3" GridLines="Vertical" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" OnSelectedIndexChanged="CustomerList_SelectedIndexChanged">
